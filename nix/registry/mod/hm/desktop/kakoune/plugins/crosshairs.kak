# Prefer theme-provided palette values (fall back to neutral gray when missing).
try %{
    set-face global crosshairs_line ",%opt{cursor_line}"
} catch %{
    set-face global crosshairs_line ",rgb:383838+bd"
}
try %{
    set-face global crosshairs_column ",%opt{bg3}+f"
} catch %{
    set-face global crosshairs_column ",rgb:383838+bd"
}
